            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Gérer les livres empruntés
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <?php if($result->isIssued=='1'): ?>
                                                            <p style="color:red;">Livre non disponible</p>
                                                        <?php endif;?>
                                                    </td>
                                                    <td class="center">                                                        
                                                    <form action="add-to-chart.php" method="post">
                                                    <!-- Form to submit book ID to add to chart -->                                                 
                                                    <input type="hidden" name="book_id" value="<?php echo htmlentities($result->bookid); ?>">
