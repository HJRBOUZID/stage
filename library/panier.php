...
"<tr>
                                ...
                                <td><img src='admin/bookimg/" .
htmlentities($book->bookImage)
 . "' width='50' /></td>

                                <td>" .
htmlentities($book->BookName)
 . "</td>

                                <td>" .
htmlentities($book->AuthorName)
 . "</td>

                                <td>" .
htmlentities($book->BookPrice)
 . "</td>

                                <td>

                                    <form action='remove-from-chart.php' method='post'>

                                        <input type='hidden' name='book_id' value='" .
htmlentities($book->id)
 . "'>
